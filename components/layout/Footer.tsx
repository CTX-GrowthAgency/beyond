    ...
    <>
      <style>{`
        ...
        .ftr-copy {
          ...
          /* Single column, everything centred */
          .ftr-top {
            grid-template-columns: 1fr;
            gap: var(--spacing-6);
          ...
          /* Tagline centred */
          .ftr-tagline { text-align: center; }

          /* Nav centred, links don't hug left */
          .ftr-nav {
            align-items: center;
            gap: var(--spacing-4);
            padding-top: 0;
          }
          .ftr-nav-link { width: auto; }

          /* Bottom row stacks and centres */
          .ftr-bottom {
            flex-direction: column;
            align-items: center;
            text-align: center;
        ...
        @media (max-width: 400px) {
          .ftr-nav-link { font-size: 11px; }
          .ftr-legal    { font-size: 10px; }
        }
      `}</style>
