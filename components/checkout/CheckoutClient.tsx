          ...
          <div>
            ...
            <div className="ck-card">
              ...
              <div className="ck-field">
                <label className="ck-label">
                  WhatsApp Number
                  <span className="ck-label-hint">(include country code, e.g. +91 98765 43210)</span>
                </label>
                <input
                  className={`ck-input${errors.whatsapp ? " error" : ""}`}
                  placeholder="e.g. +91 9876543210 or +44 7911 123456"
                  value={form.whatsapp}
                ...
                {!errors.whatsapp && (
                  <div className="ck-hint">
                    ...
                    Add country code (e.g. +91 for India). Tickets &amp; invoice will be sent here.
                  </div>
                )}
              </div>
            </div>
